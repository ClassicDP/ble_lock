...
public:
    ...
    void addCharacteristic(const std::string &uuid, bool isWritable);                              // Добавление характеристики
...
private:
    ...
    std::map<std::string, BLECharacteristic *> characteristicMap_; // Map для хранения характеристик
